...
utils/count/CMakeFiles/count.dir/count.c.o: ../utils/count/count.c
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/mnt/cilk-plus-futures/Tapir/src/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building C object utils/count/CMakeFiles/count.dir/count.c.o"
	cd /mnt/cilk-plus-futures/Tapir/src/build/utils/count && /usr/bin/cc  $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -o CMakeFiles/count.dir/count.c.o   -c /mnt/cilk-plus-futures/Tapir/src/utils/count/count.c
...
utils/count/CMakeFiles/count.dir/count.c.i: cmake_force
	...
	cd /mnt/cilk-plus-futures/Tapir/src/build/utils/count && /usr/bin/cc  $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -E /mnt/cilk-plus-futures/Tapir/src/utils/count/count.c > CMakeFiles/count.dir/count.c.i
...
utils/count/CMakeFiles/count.dir/count.c.s: cmake_force
	...
	cd /mnt/cilk-plus-futures/Tapir/src/build/utils/count && /usr/bin/cc  $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -S /mnt/cilk-plus-futures/Tapir/src/utils/count/count.c -o CMakeFiles/count.dir/count.c.s
...
bin/count: utils/count/CMakeFiles/count.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/mnt/cilk-plus-futures/Tapir/src/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking C executable ../../bin/count"
	cd /mnt/cilk-plus-futures/Tapir/src/build/utils/count && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/count.dir/link.txt --verbose=$(VERBOSE)
...
utils/count/CMakeFiles/count.dir/clean:
	cd /mnt/cilk-plus-futures/Tapir/src/build/utils/count && $(CMAKE_COMMAND) -P CMakeFiles/count.dir/cmake_clean.cmake
.PHONY : utils/count/CMakeFiles/count.dir/clean

utils/count/CMakeFiles/count.dir/depend:
	cd /mnt/cilk-plus-futures/Tapir/src/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /mnt/cilk-plus-futures/Tapir/src /mnt/cilk-plus-futures/Tapir/src/utils/count /mnt/cilk-plus-futures/Tapir/src/build /mnt/cilk-plus-futures/Tapir/src/build/utils/count /mnt/cilk-plus-futures/Tapir/src/build/utils/count/CMakeFiles/count.dir/DependInfo.cmake --color=$(COLOR)

...
set(LLVM_BUILD_BINARY_DIR "/mnt/cilk-plus-futures/Tapir/src/build")
set(LLVM_BUILD_LIBRARY_DIR "/mnt/cilk-plus-futures/Tapir/src/build/./lib")
set(LLVM_BUILD_MAIN_INCLUDE_DIR "/mnt/cilk-plus-futures/Tapir/src/include")
set(LLVM_BUILD_MAIN_SRC_DIR "/mnt/cilk-plus-futures/Tapir/src")


set(LLVM_VERSION_MAJOR 5)
set(LLVM_VERSION_MINOR 0)
set(LLVM_VERSION_PATCH 0)
set(LLVM_PACKAGE_VERSION 5.0.0git-ba2f0ed)

set(LLVM_BUILD_TYPE Release)

set(LLVM_COMMON_DEPENDS )

set(LLVM_AVAILABLE_LIBS LLVMDemangle;LLVMSupport;LLVMTableGen;LLVMCore;LLVMIRReader;LLVMCodeGen;LLVMSelectionDAG;LLVMAsmPrinter;LLVMMIRParser;LLVMGlobalISel;LLVMBinaryFormat;LLVMBitReader;LLVMBitWriter;LLVMTransformUtils;LLVMInstrumentation;LLVMInstCombine;LLVMScalarOpts;LLVMipo;LLVMVectorize;LLVMObjCARCOpts;LLVMCoroutines;LLVMTapirOpts;LLVMLinker;LLVMAnalysis;LLVMLTO;LLVMMC;LLVMMCParser;LLVMMCDisassembler;LLVMObject;LLVMObjectYAML;LLVMOption;LLVMDebugInfoDWARF;LLVMDebugInfoMSF;LLVMDebugInfoCodeView;LLVMDebugInfoPDB;LLVMSymbolize;LLVMExecutionEngine;LLVMInterpreter;LLVMMCJIT;LLVMOrcJIT;LLVMRuntimeDyld;LLVMTarget;LLVMX86CodeGen;LLVMX86AsmParser;LLVMX86Disassembler;LLVMX86AsmPrinter;LLVMX86Desc;LLVMX86Info;LLVMX86Utils;LLVMAsmParser;LLVMLineEditor;LLVMProfileData;LLVMCoverage;LLVMPasses;LLVMDlltoolDriver;LLVMLibDriver;LLVMXRay;LTO;LLVM)
...
set_property(GLOBAL PROPERTY LLVMBUILD_LIB_DEPS_LLVMipo LLVMAnalysis;LLVMBitReader;LLVMBitWriter;LLVMCore;LLVMIRReader;LLVMInstCombine;LLVMInstrumentation;LLVMLinker;LLVMObject;LLVMProfileData;LLVMScalarOpts;LLVMSupport;LLVMTapirOpts;LLVMTransformUtils;LLVMVectorize)
...
set_property(GLOBAL PROPERTY LLVMBUILD_LIB_DEPS_LLVMTapirOpts LLVMAnalysis;LLVMCore;LLVMScalarOpts;LLVMSupport;LLVMTransformUtils)
...
set(LLVM_INCLUDE_DIRS "/mnt/cilk-plus-futures/Tapir/src/include;/mnt/cilk-plus-futures/Tapir/src/build/include")
set(LLVM_LIBRARY_DIRS "/mnt/cilk-plus-futures/Tapir/src/build/./lib")
...
set(LLVM_INCLUDE_DIR "/mnt/cilk-plus-futures/Tapir/src/include;/mnt/cilk-plus-futures/Tapir/src/build/include")
set(LLVM_LIBRARY_DIR "/mnt/cilk-plus-futures/Tapir/src/build/./lib")
...
set(LLVM_CMAKE_DIR "/mnt/cilk-plus-futures/Tapir/src/cmake/modules")
set(LLVM_BINARY_DIR "/mnt/cilk-plus-futures/Tapir/src/build")
set(LLVM_TOOLS_BINARY_DIR "/mnt/cilk-plus-futures/Tapir/src/build/./bin")
set(LLVM_TOOLS_INSTALL_DIR "bin")

if(NOT TARGET LLVMSupport)
  set(LLVM_EXPORTED_TARGETS "LLVMDemangle;LLVMSupport;LLVMTableGen;llvm-tblgen;LLVMCore;LLVMIRReader;LLVMCodeGen;LLVMSelectionDAG;LLVMAsmPrinter;LLVMMIRParser;LLVMGlobalISel;LLVMBinaryFormat;LLVMBitReader;LLVMBitWriter;LLVMTransformUtils;LLVMInstrumentation;LLVMInstCombine;LLVMScalarOpts;LLVMipo;LLVMVectorize;LLVMHello;LLVMObjCARCOpts;LLVMCoroutines;LLVMTapirOpts;LLVMLinker;LLVMAnalysis;LLVMLTO;LLVMMC;LLVMMCParser;LLVMMCDisassembler;LLVMObject;LLVMObjectYAML;LLVMOption;LLVMDebugInfoDWARF;LLVMDebugInfoMSF;LLVMDebugInfoCodeView;LLVMDebugInfoPDB;LLVMSymbolize;LLVMExecutionEngine;LLVMInterpreter;LLVMMCJIT;LLVMOrcJIT;LLVMRuntimeDyld;LLVMTarget;LLVMX86CodeGen;LLVMX86AsmParser;LLVMX86Disassembler;LLVMX86AsmPrinter;LLVMX86Desc;LLVMX86Info;LLVMX86Utils;LLVMAsmParser;LLVMLineEditor;LLVMProfileData;LLVMCoverage;LLVMPasses;LLVMDlltoolDriver;LLVMLibDriver;LLVMXRay;PollyISL;PollyPPCG;Polly;LLVMPolly;LTO;LLVMgold;llvm-ar;llvm-config;llvm-lto;llvm-profdata;clang-tblgen;BugpointPasses;bugpoint;llvm-dsymutil;llc;lli;llvm-as;llvm-bcanalyzer;llvm-c-test;llvm-cat;llvm-cov;llvm-cvtres;llvm-cxxdump;llvm-cxxfilt;llvm-diff;llvm-dis;llvm-dwarfdump;llvm-dwp;llvm-extract;llvm-link;llvm-lto2;llvm-mc;llvm-modextract;llvm-mt;llvm-nm;llvm-objdump;llvm-opt-report;llvm-pdbutil;llvm-readobj;llvm-rtdyld;LLVM;llvm-size;llvm-split;llvm-stress;llvm-strings;llvm-symbolizer;llvm-xray;obj2yaml;opt;sancov;sanstats;verify-uselistorder;yaml2obj;llvm-mcmarkup;LLVMTestingSupport;gtest;gtest_main")
  include("/mnt/cilk-plus-futures/Tapir/src/build/lib/cmake/llvm/LLVMExports.cmake")
  include("/mnt/cilk-plus-futures/Tapir/src/build/lib/cmake/llvm/LLVMBuildTreeOnlyTargets.cmake")
endif()

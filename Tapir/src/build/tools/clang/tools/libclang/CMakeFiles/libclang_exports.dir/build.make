...
tools/clang/tools/libclang/libclang.exports: ../tools/clang/tools/libclang/libclang.exports
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/mnt/cilk-plus-futures/Tapir/src/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Creating export file for libclang"
	cd /mnt/cilk-plus-futures/Tapir/src/build/tools/clang/tools/libclang && echo "LLVM_5.0 {" > libclang.exports
	cd /mnt/cilk-plus-futures/Tapir/src/build/tools/clang/tools/libclang && grep -q [[:alnum:]] /mnt/cilk-plus-futures/Tapir/src/tools/clang/tools/libclang/libclang.exports && echo "  global:" >> libclang.exports || :
	cd /mnt/cilk-plus-futures/Tapir/src/build/tools/clang/tools/libclang && sed -e "s/\$$/;/" -e "s/^/    /" < /mnt/cilk-plus-futures/Tapir/src/tools/clang/tools/libclang/libclang.exports >> libclang.exports
	cd /mnt/cilk-plus-futures/Tapir/src/build/tools/clang/tools/libclang && echo "  local: *;" >> libclang.exports
	cd /mnt/cilk-plus-futures/Tapir/src/build/tools/clang/tools/libclang && echo "};" >> libclang.exports
...
tools/clang/tools/libclang/CMakeFiles/libclang_exports.dir/clean:
	cd /mnt/cilk-plus-futures/Tapir/src/build/tools/clang/tools/libclang && $(CMAKE_COMMAND) -P CMakeFiles/libclang_exports.dir/cmake_clean.cmake

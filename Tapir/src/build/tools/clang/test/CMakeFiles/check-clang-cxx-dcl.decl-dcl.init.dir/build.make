...
tools/clang/test/CMakeFiles/check-clang-cxx-dcl.decl-dcl.init:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/mnt/cilk-plus-futures/Tapir/src/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Running lit suite /mnt/cilk-plus-futures/Tapir/src/tools/clang/test/CXX/dcl.decl/dcl.init"
	cd /mnt/cilk-plus-futures/Tapir/src/build/tools/clang/test && /usr/bin/python2.7 /mnt/cilk-plus-futures/Tapir/src/utils/lit/lit.py -sv --param clang_site_config=/mnt/cilk-plus-futures/Tapir/src/build/tools/clang/test/lit.site.cfg /mnt/cilk-plus-futures/Tapir/src/tools/clang/test/CXX/dcl.decl/dcl.init
...
tools/clang/test/CMakeFiles/check-clang-cxx-dcl.decl-dcl.init.dir/clean:
	cd /mnt/cilk-plus-futures/Tapir/src/build/tools/clang/test && $(CMAKE_COMMAND) -P CMakeFiles/check-clang-cxx-dcl.decl-dcl.init.dir/cmake_clean.cmake

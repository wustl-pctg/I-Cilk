...
tools/clang/test/CMakeFiles/check-clang-cxx-basic-basic.lookup-basic.lookup.qual-class.qual:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/mnt/cilk-plus-futures/Tapir/src/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Running lit suite /mnt/cilk-plus-futures/Tapir/src/tools/clang/test/CXX/basic/basic.lookup/basic.lookup.qual/class.qual"
...
tools/clang/test/CMakeFiles/check-clang-cxx-basic-basic.lookup-basic.lookup.qual-class.qual.dir/clean:
	cd /mnt/cilk-plus-futures/Tapir/src/build/tools/clang/test && $(CMAKE_COMMAND) -P CMakeFiles/check-clang-cxx-basic-basic.lookup-basic.lookup.qual-class.qual.dir/cmake_clean.cmake

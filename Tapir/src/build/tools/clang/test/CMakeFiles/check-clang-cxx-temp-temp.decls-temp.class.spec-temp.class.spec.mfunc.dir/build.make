...
tools/clang/test/CMakeFiles/check-clang-cxx-temp-temp.decls-temp.class.spec-temp.class.spec.mfunc:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/mnt/cilk-plus-futures/Tapir/src/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Running lit suite /mnt/cilk-plus-futures/Tapir/src/tools/clang/test/CXX/temp/temp.decls/temp.class.spec/temp.class.spec.mfunc"
...
tools/clang/test/CMakeFiles/check-clang-cxx-temp-temp.decls-temp.class.spec-temp.class.spec.mfunc.dir/clean:
	cd /mnt/cilk-plus-futures/Tapir/src/build/tools/clang/test && $(CMAKE_COMMAND) -P CMakeFiles/check-clang-cxx-temp-temp.decls-temp.class.spec-temp.class.spec.mfunc.dir/cmake_clean.cmake

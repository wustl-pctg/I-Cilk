...
tools/clang/examples/analyzer-plugin/SampleAnalyzerPlugin.exports: ../tools/clang/examples/analyzer-plugin/SampleAnalyzerPlugin.exports
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/mnt/cilk-plus-futures/Tapir/src/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Creating export file for SampleAnalyzerPlugin"
	cd /mnt/cilk-plus-futures/Tapir/src/build/tools/clang/examples/analyzer-plugin && echo "LLVM_5.0 {" > SampleAnalyzerPlugin.exports
	cd /mnt/cilk-plus-futures/Tapir/src/build/tools/clang/examples/analyzer-plugin && grep -q [[:alnum:]] /mnt/cilk-plus-futures/Tapir/src/tools/clang/examples/analyzer-plugin/SampleAnalyzerPlugin.exports && echo "  global:" >> SampleAnalyzerPlugin.exports || :
	cd /mnt/cilk-plus-futures/Tapir/src/build/tools/clang/examples/analyzer-plugin && sed -e "s/\$$/;/" -e "s/^/    /" < /mnt/cilk-plus-futures/Tapir/src/tools/clang/examples/analyzer-plugin/SampleAnalyzerPlugin.exports >> SampleAnalyzerPlugin.exports
	cd /mnt/cilk-plus-futures/Tapir/src/build/tools/clang/examples/analyzer-plugin && echo "  local: *;" >> SampleAnalyzerPlugin.exports
	cd /mnt/cilk-plus-futures/Tapir/src/build/tools/clang/examples/analyzer-plugin && echo "};" >> SampleAnalyzerPlugin.exports
...
tools/clang/examples/analyzer-plugin/CMakeFiles/SampleAnalyzerPlugin_exports.dir/clean:
	cd /mnt/cilk-plus-futures/Tapir/src/build/tools/clang/examples/analyzer-plugin && $(CMAKE_COMMAND) -P CMakeFiles/SampleAnalyzerPlugin_exports.dir/cmake_clean.cmake

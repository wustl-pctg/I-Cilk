...
tools/clang/examples/PrintFunctionNames/PrintFunctionNames.exports: ../tools/clang/examples/PrintFunctionNames/PrintFunctionNames.exports
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/mnt/cilk-plus-futures/Tapir/src/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Creating export file for PrintFunctionNames"
	cd /mnt/cilk-plus-futures/Tapir/src/build/tools/clang/examples/PrintFunctionNames && echo "LLVM_5.0 {" > PrintFunctionNames.exports
	cd /mnt/cilk-plus-futures/Tapir/src/build/tools/clang/examples/PrintFunctionNames && grep -q [[:alnum:]] /mnt/cilk-plus-futures/Tapir/src/tools/clang/examples/PrintFunctionNames/PrintFunctionNames.exports && echo "  global:" >> PrintFunctionNames.exports || :
	cd /mnt/cilk-plus-futures/Tapir/src/build/tools/clang/examples/PrintFunctionNames && sed -e "s/\$$/;/" -e "s/^/    /" < /mnt/cilk-plus-futures/Tapir/src/tools/clang/examples/PrintFunctionNames/PrintFunctionNames.exports >> PrintFunctionNames.exports
	cd /mnt/cilk-plus-futures/Tapir/src/build/tools/clang/examples/PrintFunctionNames && echo "  local: *;" >> PrintFunctionNames.exports
	cd /mnt/cilk-plus-futures/Tapir/src/build/tools/clang/examples/PrintFunctionNames && echo "};" >> PrintFunctionNames.exports
...
tools/clang/examples/PrintFunctionNames/CMakeFiles/PrintFunctionNames_exports.dir/clean:
	cd /mnt/cilk-plus-futures/Tapir/src/build/tools/clang/examples/PrintFunctionNames && $(CMAKE_COMMAND) -P CMakeFiles/PrintFunctionNames_exports.dir/cmake_clean.cmake

...
polly_src_dir = '''/mnt/cilk-plus-futures/Tapir/src/tools/polly'''
polly_lib_dir = '''/mnt/cilk-plus-futures/Tapir/src/build/tools/polly/lib'''
shlibext = '''.so'''
llvm_tools_dir = '''/mnt/cilk-plus-futures/Tapir/src/build/./bin'''

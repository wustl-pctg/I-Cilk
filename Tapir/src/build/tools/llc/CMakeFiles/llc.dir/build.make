...
tools/llc/CMakeFiles/llc.dir/llc.cpp.o: ../tools/llc/llc.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/mnt/cilk-plus-futures/Tapir/src/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object tools/llc/CMakeFiles/llc.dir/llc.cpp.o"
	cd /mnt/cilk-plus-futures/Tapir/src/build/tools/llc && /usr/bin/c++   $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/llc.dir/llc.cpp.o -c /mnt/cilk-plus-futures/Tapir/src/tools/llc/llc.cpp
...
tools/llc/CMakeFiles/llc.dir/llc.cpp.i: cmake_force
	...
	cd /mnt/cilk-plus-futures/Tapir/src/build/tools/llc && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /mnt/cilk-plus-futures/Tapir/src/tools/llc/llc.cpp > CMakeFiles/llc.dir/llc.cpp.i
...
tools/llc/CMakeFiles/llc.dir/llc.cpp.s: cmake_force
	...
	cd /mnt/cilk-plus-futures/Tapir/src/build/tools/llc && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /mnt/cilk-plus-futures/Tapir/src/tools/llc/llc.cpp -o CMakeFiles/llc.dir/llc.cpp.s
...
bin/llc: tools/llc/CMakeFiles/llc.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/mnt/cilk-plus-futures/Tapir/src/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../bin/llc"
	cd /mnt/cilk-plus-futures/Tapir/src/build/tools/llc && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/llc.dir/link.txt --verbose=$(VERBOSE)
...
tools/llc/CMakeFiles/llc.dir/clean:
	cd /mnt/cilk-plus-futures/Tapir/src/build/tools/llc && $(CMAKE_COMMAND) -P CMakeFiles/llc.dir/cmake_clean.cmake
.PHONY : tools/llc/CMakeFiles/llc.dir/clean

tools/llc/CMakeFiles/llc.dir/depend:
	cd /mnt/cilk-plus-futures/Tapir/src/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /mnt/cilk-plus-futures/Tapir/src /mnt/cilk-plus-futures/Tapir/src/tools/llc /mnt/cilk-plus-futures/Tapir/src/build /mnt/cilk-plus-futures/Tapir/src/build/tools/llc /mnt/cilk-plus-futures/Tapir/src/build/tools/llc/CMakeFiles/llc.dir/DependInfo.cmake --color=$(COLOR)

...
test/CMakeFiles/check-llvm-tools-llvm-objdump-hexagon:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/mnt/cilk-plus-futures/Tapir/src/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Running lit suite /mnt/cilk-plus-futures/Tapir/src/test/tools/llvm-objdump/Hexagon"
	cd /mnt/cilk-plus-futures/Tapir/src/build/test && /usr/bin/python2.7 /mnt/cilk-plus-futures/Tapir/src/utils/lit/lit.py -sv --param llvm_site_config=/mnt/cilk-plus-futures/Tapir/src/build/test/lit.site.cfg --param llvm_unit_site_config=/mnt/cilk-plus-futures/Tapir/src/build/test/Unit/lit.site.cfg /mnt/cilk-plus-futures/Tapir/src/test/tools/llvm-objdump/Hexagon
...
test/CMakeFiles/check-llvm-tools-llvm-objdump-hexagon.dir/clean:
	cd /mnt/cilk-plus-futures/Tapir/src/build/test && $(CMAKE_COMMAND) -P CMakeFiles/check-llvm-tools-llvm-objdump-hexagon.dir/cmake_clean.cmake
...
test/CMakeFiles/check-llvm-tools-llvm-objdump-hexagon.dir/depend:
	cd /mnt/cilk-plus-futures/Tapir/src/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /mnt/cilk-plus-futures/Tapir/src /mnt/cilk-plus-futures/Tapir/src/test /mnt/cilk-plus-futures/Tapir/src/build /mnt/cilk-plus-futures/Tapir/src/build/test /mnt/cilk-plus-futures/Tapir/src/build/test/CMakeFiles/check-llvm-tools-llvm-objdump-hexagon.dir/DependInfo.cmake --color=$(COLOR)

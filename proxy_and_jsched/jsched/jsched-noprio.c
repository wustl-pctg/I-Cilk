...
static ArgOption args[] = {
  ...
  { KindOption,   Double, "-f3",           0, &fWait[3],                "Calls to Sort per second" },  { KindOption,   Integer,"--seed",        0, &rseed,                   "Random number seed" },
...
//fun0 -> wrapper for sw
int fun0(int index, struct timespec* starts, struct timespec * ends, cilk::future<int>* f,
...
int fun1(int index, struct timespec* starts, struct timespec * ends, cilk::future<int>* f,
	 int n){
  fib(n);
  clock_gettime(CLOCK_MONOTONIC, &ends[index]);
  if(f){
...
//fun2 -> wrapper for mm
int fun2(int index, struct timespec* starts, struct timespec * ends, cilk::future<int>* f,
...
int fun3(int index, struct timespec* starts, struct timespec * ends, cilk::future<int>* f,
...
int runner(int fNum, struct timespec * starts, struct timespec* ends){
  if(verbose){
